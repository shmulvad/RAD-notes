...
% Make TODO's very easy to visually spot in pdf.
\newcommand{\TODO}[1]{
  \colorbox{orange}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{
    \textbf{TODO:} #1
  }}
}
...
% O, probability, expected value and variance with dynamic () / []
\renewcommand{\O}[1]{\mathcal{O} \p{ #1 } }
\renewcommand{\P}[1]{\mathbb{P} \square{ #1 } }
\newcommand{\E}[1]{\mathbb{E} \square{ #1 } }
\newcommand{\Var}[1]{\text{Var} \square{ #1 } }

% Sum with multiple lines possible and not taking up full width of lines below
\newcommand{\summ}[1]{\sum_{\mathclap{\substack{ #1 }}}}

% A fraction, but with dynamic () around
\newcommand{\pfrac}[2]{ \p{ \frac{#1}{#2} } }

% Circle and square icons
\def\mcirc{\mathbin{\scalerel*{\bigcirc}{t}}}
\def\msquare{\mathord{\scalerel*{\Box}{gX}}}

% Parentheses a very specific height
\makeatletter
\newcommand*{\bigsl}[1]{{\hbox{$\left#1\vbox to29\p@{}\right.\n@space$}}}
\newcommand*{\bigsr}[1]{{\hbox{$\left.\vbox to29\p@{}\right#1\n@space$}}}
\makeatother
