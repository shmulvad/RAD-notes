...
Vi har to bitstrenge $a = (a_0, \dots, a_{m-1})$ og $b = (b_0, \dots, b_{m-1})$. Nu definerer vi:
$$
...
Vi får at graden af $A$ og $B$ er $d = n$, og der kan derfor højest være $n$ forskellige steder hvor de er ens. Således får vi sandsynligheden for en false positive til:
$$
  \P{\text{FP}}
  = \P{A(r) = B(r) \ | A \neq B}
  \leq \frac{n}{p}
