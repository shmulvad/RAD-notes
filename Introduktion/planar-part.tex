...
\end{align}
\textbf{TODO: Hvorfor '$\leq$'-tegnet og ikke bare '='?} % Måske noget med, at der er en hvis sandsynlighed for, at segmenterne ikke ville splitte s' da de ikke går igennem. F.eks. som vi ser på Figuren med undtagelse af det sidste segment til venstre for s'
